...
const ContactForm = () => {
  return (
    <div className="flex flex-col items-center py-10" id="contactus">
        <h2 className="text-4xl font-semibold text-green-500">Contact Us</h2>
        <div
            className="grid md:grid-cols-2 gap-8 items-center relative overflow-hidden p-4 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-3xl max-w-5xl mx-auto bg-white mt-4 font-[sans-serif] before:absolute before:right-0 before:w-[300px] before:bg-blue-400 before:h-full max-md:before:hidden">
            <div>
